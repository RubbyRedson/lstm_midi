...
data_path = "./midi_text_newdict/midi_text_newdict/bach"
...
def load_data():
    # get the data paths./midi_text_newdict/midi_text_newdict/bach/bach_846_track[1].txt
    train_path = os.path.join(data_path, "bach_846_track[1].txt")
    valid_path = os.path.join(data_path, "bach_847_track[1].txt")
    test_path = os.path.join(data_path, "bach_850_track[1].txt")
...
if args.run_opt == 1:
    ...
    trained_model = args.data_path + "/two-layer-lstm-medium-config-60-epoch-0p93-lr-decay-10-max-lr-final"
